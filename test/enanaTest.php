...
class EnanaTest extends TestCase {
    ...
    public function testHeridaLeveVive() {
        ...
        $enana = new Enana('Meredith',30,'viva');
        $this->assertEquals([20,'viva'],$enana->heridaLeve());
    }
    ...
    public function testHeridaLeveMuere() {
        ...
        $enana = new Enana('Meredith',5,'viva');
        $this->assertEquals([-5,'muerta'],$enana->heridaLeve());
    ...
    public function testHeridaGrave() {
        ...
        $enana = new Enana('Meredith',5,'viva');
        $this->assertEquals([0,'limbo'],$enana->heridaGrave());
    ...
    public function testPocimaRevive() {
        ...
        $enana = new Enana('Meredith',-5,'muerta');
        $this->assertEquals([5,'viva'],$enana->pocima());
    ...
    public function testPocimaExtraLimbo() {
        ...
        $enana = new Enana('Meredith',0,'limbo');
